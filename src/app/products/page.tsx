import { fetchBrands, fetchLayouts, fetchMaxPrice, fetchProductAmount, fetchProducts } from "@/lib/data";
...
export default async function Page({ 
    ...
    const totalPages = +await fetchProductAmount(query) || 1;
    const products = await fetchProducts(query);

    return (
        <div className="px-8">
            <h1 className="text-3xl font-bold py-6 text-center">Products</h1>
